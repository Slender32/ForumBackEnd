...
class GlobalExceptionHandler {
    ...
    fun handleFile(exception: FileException) =
        when (exception) {
            ...
            is FileNameException -> Error.REQUEST_CONTENT_INVALID
    ...
    fun handleAccessDenied(e: AccessDeniedException) =
        Error.AUTHORITY_INSUFFICIENT.toResponseEntity()

    @ExceptionHandler
    fun handleAdminResourceNotFound(e: AdminResourceNotFoundException) =
        Error.ADMIN_RESOURCE_NOT_FOUND.toResponseEntity(e.message)

    @ExceptionHandler fun handleThrowable(e: Throwable) = Error.INTERNAL.toResponseEntity()
